...
export const CommandModal = ({
  ...
  const moreRoutes: TAppRoute[] = [
    {
      id: 1,
      name: tHome("projects_title"),
      description: tHome("projects_description"),
      path: "/projects",
    ...
    {
      id: 2,
      name: tHome("repositories_title"),
      description: tHome("repositories_description"),
      path: "/repositories",
    ...
    {
      id: 3,
      name: tHome("about_me_title"),
      description: tHome("about_me_description"),
      path: "/#sobre-mim",
    ...
    {
      id: 4,
      name: tHome("donate_title"),
      description: tHome("donate_description"),
      path: "/donate",
      ...
      <main className="w-full">
        <header>
          <input
            ...
            placeholder={tCommandModal("type_a_command")}
            type="text"
